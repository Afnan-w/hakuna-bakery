      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 sm:h-18 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5 group">
            ...
            />
            <span className="text-base sm:text-lg font-display font-bold tracking-tight text-charcoal group-hover:text-hello-pink transition-colors">
              HAKUNA POTATA
            </span>
          </Link>
              ...
              >
                ...
                {location.pathname === link.path && (
                  <motion.div
                    ...
                    className="absolute -bottom-0.5 left-0 right-0 h-[1.5px] bg-hello-pink rounded-full"
                    transition={{ type: 'spring', stiffness: 300, damping: 30 }}
                  />
                )}
                {location.pathname !== link.path && (
                  <span className="absolute -bottom-0.5 left-0 right-0 h-[1.5px] bg-hello-pink/40 rounded-full origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
                )}
              </Link>
            ))}
          </nav>
          ...
          <button
            ...
            className="md:hidden p-2 text-charcoal hover:text-hello-pink transition-colors cursor-pointer"
